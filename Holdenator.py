...
refresh=.0001 #how many times per second the reaction rates will be updated
...
for x in np.arange(0,2,refresh):
    ...
    dQ = r13 - r14
    dT = -r11 + r12
    dU = -r3 + r4 + r5 - r6 - 2*r7 + 2*r8 - r9 + r10 + r11 - r12
    dV = r1 - r2
    dX = -r1 + r2 - r3 + r4 - 2*r5 + 2*r6 + r7 - r8 - r9 + r10 - r13 + r14
    dY = -r1 + r2 - r3 + r4 - r5 + r6
    dZ = -r1 + r2 + 2*r3 - 2*r4 + r5 - r6 + r7 - r8
